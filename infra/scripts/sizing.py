...
MODEL_CATALOG = {
    ...
    "RedHatAI/Qwen3-4B-FP8-dynamic":                 {"vram_gb": 6, "tier": "small",
        "num_layers": 36, "num_kv_heads": 8, "head_dim": 128, "kv_dtype_bytes": 2,
        "vllm_args": _QWEN3_THINK_ARGS,
        "note": "FP8-dynamic Qwen3-4B (RedHatAI); hybrid thinking, Apache-2.0"},
    "RedHatAI/Qwen3-0.6B-FP8-dynamic":               {"vram_gb": 2, "tier": "small",
        "num_layers": 28, "num_kv_heads": 8, "head_dim": 128, "kv_dtype_bytes": 2,
        "vllm_args": _QWEN3_THINK_ARGS,
        "note": "FP8-dynamic Qwen3-0.6B (RedHatAI); tiny hybrid Qwen3, Apache-2.0"},
    "Qwen/Qwen3-0.6B":                               {"vram_gb": 2, "tier": "small",
        "num_layers": 28, "num_kv_heads": 8, "head_dim": 128, "kv_dtype_bytes": 2,
        "vllm_args": _QWEN3_THINK_ARGS,
        "note": "tiny hybrid Qwen3 (enable_thinking toggles), Apache-2.0"},
